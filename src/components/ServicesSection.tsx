...
const services = [
  {
    icon: Palette,
    title: "הפקה טכנית וניהול ודיוק מאחורי הקלעים",
  ...
  {
    icon: Globe,
    title: "עיצוב ובינוי מתכנון הסקיצה ועד הקמת מתחם מלא",
    description: "מהרעיון הקריאטיבי ועד הביצוע בפועל, עיצוב ובינוי של חללים שמשאירים רושם",
    image: serviceImage4,
  },
  {
    icon: Sparkles,
